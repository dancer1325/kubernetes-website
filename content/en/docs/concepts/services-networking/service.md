...
3 replicas
*  Those replicas are fungible&mdash;frontends do not care which backend
they use
*  While the actual Pods that compose the backend set may change, the
...
cluster
* An Ingress lets you consolidate your routing rules into a single resource, so
...
provides extra capabilities beyond Ingress and Service
* You can add Gateway to your cluster -
