...
* use case
  * update your deployed application
    * _Example:_ specify a NEW image OR image tag
    * ways
      * `kubectl someUpdateOperation`
        * `someUpdateOperation` depend -- on the -- scenario

* _rollout_
  * allows
    * gradually shift the traffic -- to -- NEW healthy Pods /
      * FINALLY, ALL running Pods have the NEW software
  * ALLOWED |
    * daemonSets
    * deployments
    * statefulSets
...
* -- via -- [`kubectl rollout`](../../reference/kubectl/generated/kubectl_rollout/)
  * about a rollout, you can
    * pause
    * resume
    * cancel
...
releases or configurations of the same component
* It is common practice to deploy a *canary* of a
