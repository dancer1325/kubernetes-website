...
* steps
  ...
  # Deploy a Helm Release named "kubernetes-dashboard" -- via the -- kubernetes-dashboard chart
  helm upgrade --install kubernetes-dashboard kubernetes-dashboard/kubernetes-dashboard --create-namespace --namespace kubernetes-dashboard
  ```

## how to access ?

* TODO: To protect your cluster data, Dashboard deploys with a minimal RBAC configuration by default.
